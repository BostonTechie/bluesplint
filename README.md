...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create bluesplint-99f3
  fly apps create bluesplint-99f3-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bluesplint-99f3
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bluesplint-99f3-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'bluesplint-99f3-staging' does not match app name in config file 'bluesplint-99f3'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name bluesplint-99f3-db
  fly postgres attach --postgres-app bluesplint-99f3-db --app bluesplint-99f3

  fly postgres create --name bluesplint-99f3-staging-db
  fly postgres attach --postgres-app bluesplint-99f3-staging-db --app bluesplint-99f3-staging
  ```
